...
<@layout.registrationLayout displayInfo=social.displayInfo; section>
    ...
    <#elseif section = "header">
        <link href="${url.resourcesPath}/images/favicon.ico" rel="icon"/>
    ...
    <#elseif section = "form">
        <#if realm.password>
            ...
            <form id="kc-form-login" class="login-form" action="${url.loginAction}" method="post">
                    ...
                    <p class="disclaimer">
                    Designed & Developed by Secure Computing - 2023 @ Nspect<br>
                    <a class="disclaimer-link" href="https://www.nspect.io" target="_blank">Terms & Conditions</a> & 
                    <a class="disclaimer-link" href="https://www.nspect.io" target="_blank">Privacy Policy</a>.
                </p>
